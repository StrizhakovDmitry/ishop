...
<?php echo CHtml::activeTextArea($model,'parametrs',array('size'=>60,'maxlength'=>1024))?><img style="position:relative;top:2px;left:7px" title=Пример:"Ширина:30см,Цвет:синий,Вес:10кг" src="/ishop/images/question.png">
<?php echo CHtml::error($model,'parametrs')?>
</div>
<div class="row">
<?php echo CHtml::activeLabel($model,'tags')?>
<?php echo CHtml::activeTextField($model,'tags',array('size'=>60,'maxlength'=>1024))?><img style="position:relative;top:2px;left:7px" title=Пример:"Смартфоны,Galaxy,S4,Белый" src="/ishop/images/question.png">
