		...
		<div class=row>
			...
			<div class=span6><img src="<?php echo Yii::app()->request->baseUrl.'/upload/'.$model->images.'/'.$model->mainimage; ?>"></div>
			<div class=span6>
				<h4><?php echo $model->price;?> <i class="fa fa-rub"></i></h4><button id="buttonInBasket" class="btn btn-success">В корзину <i class="fa fa-shopping-cart"></i></button>

				<h4>Основные характеристики</h4>
				<p><?php echo $model->ParametrsTableHTML;?></p>
				</div>
			<div class="span12">
				<?php echo $model->ImagesHTML;?>
