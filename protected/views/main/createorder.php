...
<div class="row">
    ...
    <div class="span10">
        ...
        <table id="order">
            ...
            <tfoot id="OrderTFoot">
            <tr>
                <td colspan="3"><p style="margin-top:10px;text-align:left;">Заказ № <?php echo $model->id ?>
                        создан <?php echo date('G:i d.m.Y', $model->createtime) ?></p></td>
                <td colspan="2"><p style="margin-top:10px;text-align:right;">Сумма: <?php echo $model->totalPrice; ?>
                        Рублей</p></td>
            </tr>
            <tr>
                <td colspan="4" style="text-align:right"></td>
                <td class="noPrint">
                    <button onclick="print()" class="btn">Напечатать <i class="fa fa-print"></i></button>
                </td>
            </tr>
            </tfoot>
        </table>
