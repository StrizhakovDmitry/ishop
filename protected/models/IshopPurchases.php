 ...
 */
class IshopPurchases extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('telnum', 'required'),
            array('telnum', 'length', 'max' => 100),
            array('comment', 'length', 'max' => 1024),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, telnum, comment', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return IshopPurchases the static model class
     */
